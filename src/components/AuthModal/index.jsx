...
export function AuthModal({ isOpen, onClose, onSuccess }) {
  ...
  return (
    <div className={`w3-modal ${style.modal}`}>
      <div className={`w3-modal-content w3-card-4 w3-round-xlarge ${style.modalContent}`}>
        ...
        <div className={`w3-container ${style.modalBody}`}>
          {/* LOGIN */}
          {authMode === "login" ? (
            <form onSubmit={handleLoginSubmit}>
              <div className="w3-margin-bottom">
                <p className={style.roleTitle}>Selecione o perfil:</p>
            ...
            <form onSubmit={handleRegisterSubmit}>
              ...
              <div className={`w3-center w3-small w3-flex ${style["register-footer"]}`}>
        ...
        <footer className={`w3-container ${style["modal-footer"]}`}>
          <p className={style.footerText}>Portal Arquivo do Bem</p>
        </footer>
      </div>
    </div>
  );
